...
using System.IO;
using Tyuiu.UleevRI.Sprint5.TaskReview.V4.Lib;

namespace Tyuiu.UleevRI.Sprint5.TaskReview.V4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Дан файл С: DataSprint5 InPutDataFileTask7V4.txt (файл взять из архива  *");
